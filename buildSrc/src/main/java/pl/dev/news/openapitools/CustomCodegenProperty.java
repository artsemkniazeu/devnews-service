...
public class CustomCodegenProperty extends CodegenProperty implements CustomFormatValidation {
    ...
    public boolean isNotFormStyle() {
        return notFormStyle;
    }

    public void setNotFormStyle(final boolean notFormStyle) {
        this.notFormStyle = notFormStyle;
    }
